...
class PemeriksaanIbuHamilController extends Controller
{
    ...
    public function hitungBeratRekomendasi($usia_kandungan, $status){
        ...
        if($status == "underweight"){
            $bb_rekomendasi = $underweight[$usia_kandungan];
        }elseif($status == "normal"){
            $bb_rekomendasi = $normal[$usia_kandungan];
        }elseif($status == "overweight"){
            $bb_rekomendasi = $overweight[$usia_kandungan];
        }elseif($status == "obese"){
            $bb_rekomendasi = $obese[$usia_kandungan];
        }else{
    ...
    public function cekBeratIbuHamil(Request $request){
        ...
        $status = "";
        $bb_prakehamilan = (int)$request->berat_badan_prakehamilan;
        $tb_prakehamilan = (int)$request->tinggi_badan_prakehamilan;
        $usia_kandungan = (int)$request->usia_kandungan;
        ...
        $rekomendasi = $this->hitungBeratRekomendasi($usia_kandungan, $status);
